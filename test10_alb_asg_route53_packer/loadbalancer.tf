...
resource "aws_lb" "web_alb" {
    ...
    security_groups = [aws_security_group.alb_sg.id] #위에어 정의한 보안그룹
    # 고가용성을 위해 최소 2개의 public subnet 을 제공해야 한다.access_logs 
